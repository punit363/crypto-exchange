    ...
    >
      ...
      <td className="px-1 py-3">
        <p className="text-base font-medium tabular-nums">
          {(Number(market.lastPrice) / SCALE).toFixed(2)}
        </p>
      </td>
      <td className="px-1 py-3">
        <p className="text-base font-medium tabular-nums">
          {(Number(market.high) / SCALE).toFixed(2)}
        </p>
      </td>
      <td className="px-1 py-3">
        <p className="text-base font-medium tabular-nums">
          {(Number(market.volume) / SCALE).toFixed(2)}
        </p>
      </td>
      <td className="px-1 py-3">
        <p className={`text-base font-medium tabular-nums ${Number(market.priceChangePercent) >= 0 ? "text-[#00C278]" : "text-[#F94D5C]"}`}>
          {Number(market.priceChangePercent) > 0 ? "+" : ""}{Number(market.priceChangePercent).toFixed(2)}%
        </p>
      </td>
    </tr>
  );
