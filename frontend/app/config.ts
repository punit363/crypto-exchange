interface FrontendConfig {
  ...
  const _config: FrontendConfig = {
    ...
    SATOSHI_SCALE: parseInt(process.env.NEXT_PUBLIC_SATOSHI_SCALE || "100000000", 10),
  };
  ...
  if (typeof window === "undefined") {
    ...
    for (const key of REQUIRED_KEYS) {
      ...
      if (value === undefined || value === null || value === "") {
        console.error(`❌ FE CRITICAL BOOT FAILURE: Next.js missing environment key: NEXT_PUBLIC_${key}`);
